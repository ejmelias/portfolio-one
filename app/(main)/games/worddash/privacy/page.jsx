...
export const metadata = {
    title: 'Word Dash',
    description: 'Word Dash Privacy Policy',
}
...
export default function page() {
    ...
    return (
        <div className="bg-gray-200/50 p-5 space-y-8 border-midnight/30 border">
            Word Dash uses Google AdMob to serve mobile ads. To improve the performance of AdMob, the Google Mobile Ads SDK may collect certain information from apps, including:
